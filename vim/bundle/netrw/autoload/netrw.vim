...
if !exists("g:netrw_localcopycmd")
 ...
 if !executable(g:netrw_localcopycmd) && !executable("cmd")
...
if !executable(g:netrw_localmkdir) && !executable("cmd")
...
if !executable(g:netrw_localrmdir) && !executable("cmd")
